...
Class Conexao{//utilizar o padrão Singleton para fazer a conexão com o banco
    ...
    private function __construct(){} //construct privado para que não possa ser instanciado no código, e static para que se possa acessar os atributos e métodos sem precisar instanciar a classe
